...
export function Navigation() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-warm-white border-t border-mushroom/20 px-2 py-2 safe-area-bottom md:static md:border-t-0 md:border-r md:w-20 md:h-screen md:py-6 md:flex md:flex-col">
        ...
        {navItems.map(({ to, label, icon: Icon }) => (
          <li key={to}>
            <NavLink
              to={to}
              className={({ isActive }) =>
                `flex flex-col items-center gap-1 px-3 py-2 rounded-soft transition-colors duration-200 ${
                  isActive
                    ? 'text-terracotta'
                    : 'text-mushroom hover:text-charcoal'
                }`
              }
            >
